...
![Gaussian marginalization]({{ site.baseurl }}assets/gaussian1.png)
![Gaussian conditional]({{ site.baseurl }}assets/gaussian2.png)

# Motion models

### Velocity model
The first motion model is velocity model($v, \omega$) for a circular movement in a small time $\Delta t $.
![Velocity model]({{ site.baseurl }}assets/equation5.16.png)
...
![Beam model]({{ site.baseurl }}assets/table6.1.png)

### Landmark Model

Each landmark has a location, its measurement has range, bearing and a signature.
![Landmark model]({{ site.baseurl }}assets/equation6.40.png)
...
![Landmark model]({{ site.baseurl }}assets/table6.4.png)
...
![Mapping]({{ site.baseurl }}assets/table9.1.png)
...
![Inverse range model]({{ site.baseurl }}assets/table9.2.png)
...
![Bayes filter]({{ site.baseurl }}assets/table2.1.png)
...
![Kalman Filter]({{ site.baseurl }}assets/table3.1.png)
...
![Extended Kalman Filter]({{ site.baseurl }}assets/table3.3.png)
...
![Unscented Kalman Filter]({{ site.baseurl }}assets/table3.4.png)
...
![Particle Filter]({{ site.baseurl }}assets/table4.3.png)
...
![EKF Localization]({{ site.baseurl }}assets/table7.2.png)
...
![UKF Localization]({{ site.baseurl }}assets/table7.4.png)
...
![Particle Localization]({{ site.baseurl }}assets/table8.2.png)

Comparision of common localization algorithms.
![Localization]({{ site.baseurl }}assets/table8.6.png)
...
![EKF SLAM]({{ site.baseurl }}assets/table10.1.png)
...
![SLAM Posterior]({{ site.baseurl }}assets/equation11.15.png)
Using EKF style linearization and reorder terms, the log likelihood of the full slam become
![SLAM linearized Posterior]({{ site.baseurl }}assets/equation11.19.png)
Solving for the $y_{0:t}$ that maximize 11.20 gives $y_{0:t} = \Sigma^{-1} \xi$. To construct $\Sigma$ and $\xi$ directly, for each motion:
![SLAM motion]({{ site.baseurl }}assets/equation11.22.png)
For each measurement
![SLAM measurement]({{ site.baseurl }}assets/equation11.24.png)
...
![GraphSLAM]({{ site.baseurl }}assets/table11.5.png)
...
![GraphSLAM correspondence test]({{ site.baseurl }}assets/table11.8.png)
...
![FastSLAM]({{ site.baseurl }}assets/table13.1.png)
...
![POMDP]({{ site.baseurl }}assets/table15.2.png)
...
![POMDP]({{ site.baseurl }}assets/table15.1.png)
...
![Particle POMDP]({{ site.baseurl }}assets/table16.3.png)
